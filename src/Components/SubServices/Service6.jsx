		...
		<section className="text-gray-600 body-font">
			<div className="container px-5 py-20 mx-auto">
				<div className="flex flex-col md:flex-row -mx-4 -mb-10">
						...
						<div className="rounded-md w-full flex flex-col items-center sticky top-20">
							<div className="w-full md:w-3/4 rounded-md shadow-2xl">
								...
								<div className="flex items-center justify-center gap-4 m-4">
									...
									<p className="font-Noto-Sans-JP ">Quality Content Marketing</p>
								</div>
								<div className="flex items-center justify-center gap-4 m-4">
								...
								<div className="flex items-center justify-center gap-4 m-4">
									...
									<p className="font-Noto-Sans-JP ">Build Trust and Authority </p>
								</div>
							</div>
					...
					PPC advertising is a cost-effective way to drive targeted traffic to your website. Our PPC specialists design and manage campaigns on platforms like Google Ads and social media networks, ensuring that your ads reach the right people at the right time. We continuously optimize your campaigns to maximize ROI and achieve your business goals.
