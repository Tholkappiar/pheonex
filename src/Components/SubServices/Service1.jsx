            ...
            <div className="flex justify-between my-20">
                <div className="md:w-1/2 p-4">
                    ...
                    <p className="indent-20 my-4 font-light leading-7">
                        Software development is the intricate process of
                        designing, creating, testing, and maintaining software
                        applications and systems. It begins with requirement
                        analysis, where developers understand the needs and
                        objectives of users or clients. This is followed by the
                        design phase, where the architecture and components of
                        the software are planned. The implementation phase
                        involves writing the actual code using various
                        programming languages. Once the code is written, it
                        undergoes thorough testing to identify and fix any bugs,
                        ensuring the software works correctly. After successful
                        testing, the software is deployed and made available for
                        use.
                    </p>
                    <div className="mt-20">
                        {serviceSteps.map((step, index) => (
                            <div
                                key={index}
                                className="flex gap-10 items-center my-14"
                            >
                                <img
                                    src={step.icon}
                                    className="size-10"
                    ...
                    <div>
                        ...
                        <p className="font-Noto-Sans-JP leading-7 text-gray-600 tracking-wide my-10">
                            Choosing Pheonex means partnering with a team that
                            is dedicated to your success. Our client-focused
                            approach ensures that we deliver solutions that are
                            not only technologically advanced but also aligned
                            with your business goals. We are committed to
