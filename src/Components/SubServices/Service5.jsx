...
const Service5 = () => {
	return (
		<section className="text-gray-600 body-font">
			<div className="container mx-auto flex px-20 py-36 flex-col xl:flex-row">
				...
				<div className="lg:flex-grow xl:w-1/2 xl:pl-24 flex flex-col md:items-start md:text-left items-center text-center mt-8">
					...
					At Pheonex, we offer comprehensive content management services that ensure your digital content is organized, 
					up-to-date, and easily accessible. Our solutions are designed to help you manage your content effectively,
